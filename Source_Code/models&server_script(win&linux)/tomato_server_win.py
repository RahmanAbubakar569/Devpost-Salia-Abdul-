...
class_names = ['healthy', 'leaf_blight', 'leaf_curl', 'septoria_leaf_spot', 'verticulium_wilt']
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "tomato_model.pth")
...
if __name__ == '__main__':
    ...
    app.run(host='127.0.0.1', port=3030, debug=False, threaded=True)