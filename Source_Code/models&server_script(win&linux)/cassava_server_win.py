...
MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "best_efficientnet_cassava.pth")
...
if __name__ == '__main__':
    ...
    app.run(host='127.0.0.1', port=1010, debug=False, threaded=True)